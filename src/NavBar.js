            ...
            >
                ...
                <div className={ (!isSelected)? 'collapse navbar-collapse': 'navbar-collapse'}id="navbarNavAltMarkup">
                    <div className="navbar-nav">
                        <NavLink exact="true" to="/Harry-Potter-App" className={({ isActive }) => isActive? "nav-link active": 'nav-link'} aria-current="page" href="#"><i className="fas fa-hat-wizard"></i> Personajes</NavLink>
